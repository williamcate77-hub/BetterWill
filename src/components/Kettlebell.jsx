        ...
        <div className="flex items-center justify-between">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <span className="text-[11px] font-semibold tracking-widest text-zinc-500 uppercase">Daily · 100 swings</span>
              {isComplete && (
            ...
            <p className="text-xs text-zinc-500 mt-0.5">
              {swings}/100 swings · {data.taps}/{TARGET} sets of 20
            </p>
          </div>
          <ProgressRing
            progress={progress}
